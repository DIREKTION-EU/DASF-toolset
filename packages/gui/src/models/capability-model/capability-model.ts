    ...
    data: {
      ...
      capabilities: [
        ...
        },
        {
          ...
          categoryId: "C1",
          subcategoryId: "P2",
          label: "Prevent money laundering",
        },
        {
          id: "DI1",
          categoryId: "C1",
          subcategoryId: "P3",
          label: "Platform disruption",
        },
        {
          id: "DI2",
          categoryId: "C1",
          subcategoryId: "P3",
          label: "Undercover work",
        },
        {
          id: "DI3",
          categoryId: "C1",
        ...
        },
        {
          ...
          categoryId: "C1",
          subcategoryId: "P3",
          label: "Offensive work",
        },
        {
          id: "DI5",
          categoryId: "C1",
          subcategoryId: "P3",
          label: "Confiscate valuta",
        },
        {
          id: "FA1",
          categoryId: "C1",
        ...
        },
        {
          ...
          categoryId: "C2",
          subcategoryId: "E3",
          label: "Joint investigations",
        },
        {
          id: "CL3",
          categoryId: "C2",
          subcategoryId: "E3",
          label: "Create non-LEA network",
        },
        {
          id: "CL4",
          categoryId: "C2",
      ...
      mainTasks: [
        {
          id: "MG1",
          label: "Preventing dark web & cryptocurrency criminality",
        },
        {
          id: "MG2",
          label: "Reduce impact of dark web & cryptocurrency criminality",
        },
        {
          id: "MG3",
          label:
            "Finding, arresting and prosecuting criminals operating on the dark web",
        },
      ],
      taskScale: [
