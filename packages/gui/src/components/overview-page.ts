...
import { Select, FlatButton, TextInput } from "mithril-materialized";
...
export const OverviewPage: MeiosisComponent = () => {
  ...
  return {
    ...
    view: ({ attrs }) => {
      ...
      const filterStakeholders = createStakeholderFilter(
        stakeholderFilter as string[],
      );
      ...
      return m(".overview.page", [
        // TODO Replace with Sidenav component in mithril-materialized
        m(
          ...
          m("#slide-out-content.row", [
            ...
            [
              m(TextInput, {
                ...
                onchange: (v?: string) =>
                  actions.update(attrs, { textFilter: v as string }),
            ...
            stakeholderOpts &&
              m(Select, {
                ...
                onchange: (f) =>
                  actions.update(attrs, { stakeholderFilter: f as string[] }),
                className: "col s12",
              }),
            m(FlatButton, {
              label: t("clear_all"),
            ...
            logo &&
              m(
                ".center-align",
                m("img[title=Logo][width=80%]", { src: logo }),
              ),
          ]),
        ),
        m(
                        ...
                        m(
                          ...
                          m(".card-content.white-text", [
                            m(
                              ...
                              {
                                style:
                                  "padding: 0.4rem; border: 2px solid black",
                              },
                              m("strong", sc.label),
                            ),
                            m(
